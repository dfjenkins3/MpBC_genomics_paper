...
fig2 <- draw(Heatmap(rbind(nsolver_assign_adaptF_ALL, genelist_sigs_all),
                     cluster_rows = T, top_annotation = topha2,
                     name="Pathway\nActivity",
                     cluster_columns = hclust(dist(t(nsolver_assign_adaptF_ALL)))),
     annotation_legend_side="bottom", split = rep(c("adaptF", "adaptT"), c(8,3)))
